...
import AddProjectStatus from "./ProjectComponent/AddProjectStatus";
import ViewProjectStatus from "./ProjectComponent/ViewProjectStatus";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/employee/project/status/add"
          element={<AddProjectStatus />}
        />

        <Route path="/project/status/view" element={<ViewProjectStatus />} />
      </Routes>
    </div>
  );
}
